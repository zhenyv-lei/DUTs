...
if [ ! -f "$CHIPYARD_ENV" ]; then
  ...
  echo "Run: ../../scripts/setup_target.sh boomv3-medium" >&2
  return 1
fi
...
export BOOM_TARGET="boomv3-medium"
export BOOM_CONFIG="MediumBoomV3CosimConfig"
export BOOM_DUAL_CONFIG="DualMediumBoomV3CosimConfig"
