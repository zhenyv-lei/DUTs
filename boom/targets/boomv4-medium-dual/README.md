...
This DUT wrapper runs the dual-core debug `DualMediumBoomV4CosimConfig` through the shared Chipyard
...
../../chipyard/sims/verilator/output/chipyard.harness.TestHarness.DualMediumBoomV4CosimConfig/
```
