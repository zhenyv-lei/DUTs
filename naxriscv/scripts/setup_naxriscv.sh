...
DUTS_ROOT="${DUTS_ROOT:-$(CDPATH= cd "$NAXRISCV_WORKSPACE/.." && pwd -P)}"
NAXRISCV_DIR="${NAXRISCV_DIR:-$NAXRISCV_WORKSPACE/NaxRiscv}"
...
BOSC_PROXY_SCRIPT="${BOSC_PROXY_SCRIPT:-/nfs/home/leizhenyu/.codex/skills/bosc-ivp6-proxy-install/scripts/with_bosc_proxy.sh}"
